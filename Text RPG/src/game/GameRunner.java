...
class GameRunner {
    ...
    public static void intro() {
        ...
        Window.appendText("The War ended when the being disappeared one day and was never seen again... However the humans, the weakest and the most afraid");
        Window.appendText("created demons in order to find and destroy the being. After some time the humans succeeded and sent them to roam the world.");
        Window.appendText("The demons the demons that the humans created were all bound by a spell by the most powerful of the remaining wizards and the demons were unable to escape");
        ...
        Window.appendText("This mingling brought up new races such as the Elves, humanoid existences that surround themselves with nature and that task themselves with the tak of");
